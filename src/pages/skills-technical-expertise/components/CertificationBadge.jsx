    ...
    >
      <div className={`relative w-full h-full transition-transform duration-700 transform-style-preserve-3d ${
        ...
        <div className="absolute inset-0 w-full h-full backface-hidden">
          <div className="h-full p-6 bg-card border border-border rounded-xl hover:border-primary/30 transition-all duration-300 flex flex-col">
            {/* Header */}
            ...
            <div className="flex-1">
              <h3 className="font-poppins font-semibold text-foreground mb-2 group-hover:text-primary transition-colors">
                {certification.name}
              </h3>
              <p className="text-sm text-primary font-medium mb-2">{certification.issuer}</p>
        ...
        <div className="absolute inset-0 w-full h-full backface-hidden rotate-y-180">
          <div className="h-full p-6 bg-card border border-primary/30 rounded-xl flex flex-col">
            {/* Header */}
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-poppins font-semibold text-primary">Verification Details</h3>
            ...
            <div className="space-y-3 flex-1">
              <div>
                <h4 className="text-sm font-semibold text-foreground mb-2">Verification:</h4>
                <div className="space-y-2">
                  <Button
                    variant="outline"
                    size="sm"
              ...
              <div className="border-t border-border pt-4">
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center space-x-2">
                    <div className="text-lg font-bold text-accent">{certification.score}</div>
                    <div className="text-sm text-muted-foreground">/ {certification.maxScore}</div>
                  </div>
                </div>
